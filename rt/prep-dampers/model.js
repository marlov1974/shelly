// prep-dampers model 1.7.0-compact-output
...
function startPlanForPeriod(periodName) { if (periodName === "p1") return "4;0;0;0"; return "0;0;0;0"; }
...
function buildPrep(ctx) {
  ...
  return "r=" + required + "|p=" + startPlanForPeriod(ctx.periodName) + "|l=" + buildLevelData(ctx.periodName, ctx.priceCsv);
}
