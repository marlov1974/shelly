...
function applyInputs(ctx, telM, telAct) {
  ...
  ctx.inp.dmp_run = getTelActBoolValue(telAct, "dmp", "run", 0);
  ctx.inp.sup_run = getTelActBoolValue(telAct, "sup", "run", 0);
  ctx.inp.ext_run = getTelActBoolValue(telAct, "ext", "run", 0);
